...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'vipernt@sakhi.my.id',
  ...
  footer:
    'Powered by <a href="https://github.com/ViperisGOD/wanderiv" target="_blank" rel="noopener noreferrer">onedrive-cf-index-ng</a>. Made with ❤ by ViperNT.',
  ...
  email: 'mailto:vipernt@sakhi.my.id',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/ViperisGOD',
    },
  ],
